              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <!--  <tr>
                    <td>
                      <div class="form-group">
                        <label for="inputName">GIÁ LIÊN HỆ</label>
                        <input type="text" name="contactcost" class="form-control">
                      </div>
                    </td>
                  </tr> -->
                    ...
                    <div class="form-group">
                      <select class="form-control select2" name="producthot" style="width: 100%;">
                    ...
                    <div class="form-group">
                      <select class="form-control select2" name="productnew" style="width: 100%;">
                        <option value="0">1. KHÔNG</option>
                        <option value="1">2. Có</option>
                      </select>
                    </div>
