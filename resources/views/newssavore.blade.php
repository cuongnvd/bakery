...
<div class="wrapCont">
            <div class="wrapper">
                <div class="box_mid">
                    <div class="mid-title">
                        <div class="titleL">
                            <h1 style="font-size: 35px!important; color: #585858; margin-top: 5%">BẢN TIN SAVOURÉ</h1>
                        </div>
                    </div>
                    <div class="mid-content">
                        @foreach($newssavore as $row)
                        <div class="row">
                                ...
                                <div class="bignews">
                                    ...
                                    <div class="content">
                                        ...
                                        <h3 style="font-weight: bold;">
                                            <a href="{{route('chitiet', ['id' => $row->id])}}" style="font-size: 30px ">
                                                {{$row->title}}
                                            </a>
                                        </h3>
